...
// =====================
const char* MQTT_DATA_HOST = "otrobroker.ejemplo.com";  // Reemplaza con el host de tu segundo broker
const int   MQTT_DATA_PORT = 8883;                      // Reemplaza con el puerto correspondiente
const char* MQTT_DATA_USER = "usuarioData";             // Reemplaza con el usuario
const char* MQTT_DATA_PASS = "passwordData";            // Reemplaza con la contraseña
...
void setup() {
  ...
  // Para firmware/OTA
  espClient.setInsecure();  // Para demo; en producción valida el certificado
